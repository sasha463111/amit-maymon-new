...
import { PARTS_STATUS_LABELS, PROFESSIONAL_STEP_LABELS as DEFAULT_STEP_LABELS } from '@/types/database';
...
export function CaseDetailClientV2(props: CaseDetailClientProps) {
  ...
  // Field-editing, notes, and painter-status state used to live here but was
  // checked to be private to the "פרטי תיק" card alone — moved into
  // CaseDetailsSection.tsx (self-contained, not lifted) as part of the
  // god-component refactor.
